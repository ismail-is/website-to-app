...
import TacSLider from "../../_components/sliders/TacSLider";
...
const Tac = () => {
              ...
              <div className="row justify-content-between">
                  <div className="col-lg-5">
                      ...
                      <div className="mil-mb-60">
                          <span className="mil-suptitle mil-upper mil-up mil-mb-30"> The Architecture Corporation </span>
                          <h2 className="mil-upper mil-up mil-mb-30" >Collaborating with   <span class="mil-marker"> TAC </span></h2>
                      </div>

                  </div>
                  <div className="col-lg-7 mil-mt-suptitle-offset" id='SystemShow'>
                      <div className="mil-text mil-up mil-mb-30" >The Mangalore-based Architecture Corporation specializes in innovative design for residential, commercial, and luxury spaces, offering tailored solutions that bring exceptional interiors, landscapes, and high-rise projects to life.</div>
                      ...
                      <div className="row">
                              ...
                              {/* <div className="mil-item-frame mil-up mil-mb-30"> */}
                                  <div className="mil-about-counter mil-center">
                                      <div className="mil-avatar mil-mb-10">
                                          <img src=' ./img/allimg/logo/TAC.webp' alt='img' />
                                      </div>
                          ...
                          <div className="col-lg-8">
                              ...
                              <div className="mil-text mil-up mil-mb-30" >Bright Media has captured their unique design style, creating a website that perfectly aligns with their vision and aesthetic, reflecting the essence of their architectural approach.</div>
  ...
  >
    ...
    >
      <p>
      The Mangalore-based Architecture Corporation specializes in innovative design for residential, commercial, and luxury spaces, offering tailored solutions that bring exceptional interiors, landscapes, and high-rise projects to life.
      </p>
      <p>Bright Media has captured their unique design style, creating a website that perfectly aligns with their vision and aesthetic, reflecting the essence of their architectural approach.</p>
    </div>
  </div>
</div>
              ...
              <div className="row">
                  <div className="col-md-6 col-lg-6">
                      ...
                      <div className="mil-prev-project mil-mb-60">
                          ...
                          <Link href='/Tonino' className="mil-link mil-left-link mil-upper mil-up">Previous work <span className="mil-arrow"><img src="./img/icons/1.svg" alt="arrow" /></span></Link>
                      </div>
