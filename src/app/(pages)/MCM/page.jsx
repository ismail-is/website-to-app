              ...
              <div className="row">
                  <div className="col-md-6 col-lg-6">
                      ...
                      <div className="mil-prev-project mil-mb-60">
                          ...
                          <Link href='/Metroways' className="mil-link mil-left-link mil-upper mil-up">Previous work <span className="mil-arrow"><img src="./img/icons/1.svg" alt="arrow" /></span></Link>
                      </div>
