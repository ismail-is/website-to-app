...
const Kaiser = () => {
  ...
  >
    {/* Image Section */}
    <img
      src="./img/covers/project/kaiser.webp"
      alt="Bajaj Auto"
      style={{
        float: 'left',
        width: '100px',
              ...
              <div className="row">
                  <div className="col-md-6 col-lg-6">
                      ...
                      <div className="mil-prev-project mil-mb-60">
                          ...
                          <Link href='/Tac' className="mil-link mil-left-link mil-upper mil-up">Previous work <span className="mil-arrow"><img src="./img/icons/1.svg" alt="arrow" /></span></Link>
                      </div>
                  ...
                  <div className="col-md-6 col-lg-6">
                      <div className="mil-next-project mil-mb-60">
                          ...
                          <Link href='/Azimgroup' className="mil-link mil-upper mil-up">Next work <span className="mil-arrow"><img src="./img/icons/1.svg" alt="arrow" /></span></Link>
                      </div>
                  </div>
              </div>
          </div>
