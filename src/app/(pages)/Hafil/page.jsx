...
const Hafil = () => {
              ...
              <div className="row justify-content-between">
                  <div className="col-lg-5">
                      ...
                      <div className="mil-mb-60">
                          <span className="mil-suptitle mil-upper mil-up mil-mb-30">Hafil </span>
                          <h2 className="mil-upper mil-up mil-mb-30" >Partnering wiht Merkom Construction  <span class="mil-marker"> Materiels </span></h2>
                      </div>

                  </div>
                  <div className="col-lg-7 mil-mt-suptitle-offset" id='SystemShow'>
                      <div className="mil-text mil-up mil-mb-30" >Hafil Trading & Services, based in Qatar, is a trusted provider of premium hospitality solutions for hotels, resorts, restaurants, and catering businesses.   </div>
                      ...
                      <div className="row">
                          ...
                          <div className="col-lg-8">
                              ...
                              <div className="mil-text mil-up mil-mb-30" >At Bright Media, we had the pleasure of crafting their brand identity from scratch, designing a distinctive logo, developing comprehensive branding, and building a fully responsive website. Our work ensured Hafil their digital presence and their dedication to excellence in the hospitality industry.</div>
  ...
  >
    {/* Image Section */}
    <img
      src=" ./img/covers/project/hafil.webp"
      alt="Bajaj Auto"
      style={{
        float: 'left',
        width: '100px',
    ...
    >
      <p>
      Hafil Trading & Services, based in Qatar, is a trusted provider of premium hospitality solutions for hotels, resorts, restaurants, and catering businesses. 
      </p>
      <p>At Bright Media, we had the pleasure of crafting their brand identity from scratch, designing a distinctive logo, developing comprehensive branding, and building a fully responsive website. Our work ensured Hafil their digital presence and their dedication to excellence in the hospitality industry.</p>
    </div>
  </div>
</div>
              ...
              <div className="row">
                  <div className="col-md-6 col-lg-6">
                      ...
                      <div className="mil-prev-project mil-mb-60">
                          ...
                          <Link href='/Azimgroup' className="mil-link mil-left-link mil-upper mil-up">Previous work <span className="mil-arrow"><img src="./img/icons/1.svg" alt="arrow" /></span></Link>
                      </div>
