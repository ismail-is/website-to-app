            ...
            >
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        ...
                        <img src='./img/Hafil/hafilprofil.webp' alt='img'  />
                        </div>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        <div className="mil-image-frame">
                        <img src='./img/Hafil/Hafillogo.webp' alt='img'  />
                        </div>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        <div className="mil-image-frame">
                        <img src='./img/Hafil/Hafil.webp' alt='img'  />
                        </div>
                    </div>
