            ...
            >
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        ...
                        <img src='./img/allimg/azim/Azim1.webp' alt='img'  />
                        </div>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        <div className="mil-image-frame">
                        <img src='./img/allimg/azim/Azim 2.webp' alt='img'  />
                        </div>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        <div className="mil-image-frame">
                        <img src='./img/allimg/azim/Azim web.webp' alt='img'  />
                        </div>
                    </div>
