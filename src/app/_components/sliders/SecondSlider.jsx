            ...
            >
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        ...
                        <img src='./img/allimg/second cup/Second Cup .webp' alt='img'  />
                        </div>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        <div className="mil-image-frame">
                        <img src='./img/allimg/second cup/Second Cup1.webp' alt='img'  />
                        </div>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        <div className="mil-image-frame">
                        <img src='./img/allimg/second cup/Second Cup3.webp' alt='img'  />
                        </div>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        <div className="mil-image-frame">
                        <img src='./img/allimg/second cup/Second Cup5.webp' alt='img'  />
                        </div>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="mil-illustration mil-fw-item" data-swiper-parallax-x="50" data-swiper-parallax-scale="1.3">
                        <div className="mil-image-frame">
                        <img src='./img/allimg/second cup/Second Cup6.webp' alt='img'  />
                        </div>
                    </div>
